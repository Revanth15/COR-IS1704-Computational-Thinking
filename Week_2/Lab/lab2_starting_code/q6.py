...
print(compute_phone_bill(35.5, 2, num_minutes_extra_calls=100)) # Answer: 50.5
print(compute_phone_bill(35.5, 2, num_minutes_extra_calls=100, num_extra_sms=100)) # Answer: 55.5